...
const double _kMinSegmentedControlHeight = Styles.buttonSize;
...
// amount of time.
const double _kMinThumbScale = 0.91;
...
// vertex of the ArnaSlidingSegmentedControl's Rect.
//
...
class _Segment<T> extends StatefulWidget {
  ...
  // Whether the thumb of the parent widget (ArnaSlidingSegmentedControl)
...
class ArnaSlidingSegmentedControl<T> extends StatefulWidget {
  ...
  ///   @override
  ///   Widget build(BuildContext context) {
  ///     return ArnaSlidingSegmentedControl<int>(
  ///       children: children,
  ...
  ///
  /// The default value is [ArnaColors.tertiarySystemFill]. The background
  ...
  ///
  /// The default value is a [ArnaDynamicColor] that appears white in light
  ...
  @override
  State<ArnaSlidingSegmentedControl<T>> createState() =>
...
class _SegmentedControlState<T> extends State<ArnaSlidingSegmentedControl<T>>
  ...
  @override
  void didUpdateWidget(ArnaSlidingSegmentedControl<T> oldWidget) {
    super.didUpdateWidget(oldWidget);
  ...
  void onHoverChangedByGesture(T newValue) {
    ...
    // the current thumb will be painted at the same location twice (before and
    // after the new animation starts).
    // thumbController.animateWith(_kThumbSpringAnimationSimulation); //TODO
    // thumbAnimatable = null; //TODO
  }
  ...
  // The segment the user is currently hovering.
  T? hovered;
  ...
  Widget build(BuildContext context) {
    ...
    bool isPreviousSegmentHovered = false;
    ...
    return UnconstrainedBox(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: ArnaDynamicColor.resolve(widget.backgroundColor, context),
        ),
            ...
            return _SegmentedControlRenderWidget<T>(
              ...
              thumbColor: widget.thumbColor ??
                  ArnaDynamicColor.resolve(
                    ArnaTheme.of(context).accentColor,
                    context,
                  ), //ArnaDynamicColor.resolve(widget.thumbColor, context),
