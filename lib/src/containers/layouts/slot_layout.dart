...
/// See also:
///
/// * [ArnaAdaptiveLayout], where [SlotLayout]s are assigned to placements on
///   the screen called "slots".
class SlotLayout extends StatefulWidget {
  ...
  ///
  /// If you define a given animation phase, there may be multiple widgets
  /// being displayed depending on the phases you have chosen to animate.
...
class SlotLayoutConfig extends StatelessWidget {
  ...
  /// An empty [SlotLayoutConfig] to be placed in a slot to indicate that the
  /// slot should show nothing.
